...
/**
 * Servlet implementation class CommonActionBean3
 */
@WebServlet("/CommonActionBean3")
public class CommonActionBean3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommonActionBean3() {
        super();
	        ...
	        if (ServletFileUpload.isMultipartContent(request)) {
	     	    ...
	     	    try {
	     	        ...
	     	        if (session.getAttribute("username") != null) {
	     	            if (helper.updateSingleCar(carInputBean)) {
	     	    ...
	     	    try {
	     	        request.getRequestDispatcher("AllCarTable.jsp").forward(request, response);
